...
[extra]
template = "index.html"
desc = {title = "Björn Kleipool", img = "profile.jpg", text = "Resume and Project portfolio."}
+++

# 👜 Experience
- **Simulations Engineer** | Delft Aerospace Rocket Engineering _(2022-2024)_
...
- **MSc Aerospace Engineering**, Control & Simulations Track | TU Delft _(2024-2027)_
    - Specialising in Control and Simulation.
    - Followed courses on Automatic Flight Control Systems, Stochastic Control Theory & Linear Programming.
...
# 🔬 Skills
- **Technical Knowledge**: Mathematical modeling, Machine learning (AI), Technical problem solving.
- **Programming**: Python, Rust, C++, MatLab, Git, $\LaTeX$.
- **Languages**: Dutch (Native), English (Bilingual).

# 📄 Certificates
- **Cambridge Certificate of Proficiency in English**
- **EASA Class 2 Aviation Medical Certificate**
